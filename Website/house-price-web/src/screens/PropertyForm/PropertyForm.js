...
const PropertyForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataToSend = {
        MSSubClass: parseInt(formData.msSubClass, 10),
        MSZoning: formData.msZoning,
        LotFrontage: parseInt(formData.lotFrontage, 10),
        LotArea: parseInt(formData.lotArea, 10),
        ...
        OverallQual: parseInt(formData.overallQual, 10),
        OverallCond: parseInt(formData.overallCond, 10),
        YearBuilt: parseInt(formData.yearBuilt, 10),
        RoofStyle: formData.roofStyle,
        RoofMatl: formData.roofMatl,
        Exterior1st: formData.exterior1st,
        Exterior2nd: formData.exterior2nd,
        MasVnrType: formData.masVnrType,
        MasVnrArea: parseInt(formData.masVnrArea, 10),
        ExterQual: formData.exterQual,
        ExterCond: formData.exterCond,
        Foundation: formData.foundation,
        BsmtQual: formData.bsmtQual,
        BsmtCond: formData.bsmtCond,
        BsmtExposure: formData.bsmtExposure,
        BsmtFinType1: formData.bsmtFinType1,
        BsmtFinSF1: parseInt(formData.bsmtFinSF1, 10),
        BsmtFinType2: formData.bsmtFinType2,
        BsmtFinSF2: parseInt(formData.bsmtFinSF2, 10),
        BsmtUnfSF: parseInt(formData.bsmtUnfSF, 10),
        TotalBsmtSF: parseInt(formData.totalBsmtSF, 10),
        Heating: formData.heating,
        HeatingQC: formData.heatingQC,
        CentralAir: formData.centralAir,
        Electrical: formData.electrical,
        f_1stFlrSF: parseInt(formData.firstFlrSF, 10),
        f_2ndFlrSF: parseInt(formData.secondFlrSF, 10),
        LowQualFinSF: parseInt(formData.lowQualFinSF, 10),
        GrLivArea: parseInt(formData.grLivArea, 10),
        BsmtFullBath: parseInt(formData.bsmtFullBath, 10),
        BsmtHalfBath: parseInt(formData.bsmtHalfBath, 10),
        FullBath: parseInt(formData.fullBath, 10),
        HalfBath: parseInt(formData.halfBath, 10),
        BedroomAbvGr: parseInt(formData.bedroom, 10),
        KitchenAbvGr: parseInt(formData.kitchen, 10),
        KitchenQual: formData.kitchenQual,
        TotRmsAbvGrd: parseInt(formData.totRmsAbvGrd, 10),
        Functional: formData.functional,
        Fireplaces: parseInt(formData.fireplaces, 10),
        FireplaceQu: formData.fireplaceQu,
        GarageType: formData.garageType,
        GarageYrBlt: parseInt(formData.garageYrBlt, 10),
        GarageFinish: formData.garageFinish,
        GarageCars: parseInt(formData.garageCars, 10),
        GarageArea: parseInt(formData.garageArea, 10),
        GarageQual: formData.garageQual,
        GarageCond: formData.garageCond,
        PavedDrive: formData.pavedDrive,
        WoodDeckSF: parseInt(formData.woodDeckSF, 10),
        OpenPorchSF: parseInt(formData.openPorchSF, 10),
        EnclosedPorch: parseInt(formData.enclosedPorch, 10),
        f_3SsnPorch: parseInt(formData.threeSsnPorch, 10),
        ScreenPorch: parseInt(formData.screenPorch, 10),
        PoolArea: parseInt(formData.poolArea, 10),
        PoolQC: formData.poolQC,
        Fence: formData.fence,
        MiscFeature: formData.miscFeature,
        MiscVal: parseInt(formData.miscVal, 10),
        MoSold: parseInt(formData.moSold, 10),
        YrSold: parseInt(formData.yrSold, 10),
        SaleType: formData.saleType,
        SaleCondition: formData.saleCondition,
        TotalSF:
          parseInt(formData.firstFlrSF, 10) +
          parseInt(formData.totalBsmtSF, 10), // Example calculation
      };
